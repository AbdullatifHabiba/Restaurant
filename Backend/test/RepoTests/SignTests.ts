...
describe("SignIn Repo", () => {
  ...
  describe("SignUp Repo", () => {
    ...
    it('check added item is ok',() => {
      obj.AddNewEmailCustomer('123','mohamed','mohamed@','123').then((accepted)=> expect(accepted).to.equals('item added correctly'),
        (rejected) => console.log("Erron"+rejected));
    });
    ...
    it('shoud return void',() => {
      ...
      it('check added item is ok',() => {
        obj.AddNewEmailCustomer("123","a","a","a").then((accepted)=> expect(accepted).to.equals('item added correctly'),
          (rejected) => console.log("Erron"+rejected));
      });
      describe
